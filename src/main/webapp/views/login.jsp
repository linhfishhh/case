...
<head>
    ...
    <style>
        ...
        .cover-photo {
            ...
            left: 0px;
            top: -900px;
            background: linear-gradient(rgba(35, 43, 85, 0.75), rgba(35, 43, 85, 0.95)), url(https://cdn.helpex.vn/upload/2019/09/25/05-00-00-000-e15719a1-3076-45c5-ad1d-9da257c4d7d2.jpg);
            background-size: cover;
            opacity: 0;
        ...
        .profile-photo {
            ...
            left: 155px;
            top: -1000px;
            background: url(https://yt3.ggpht.com/_tmlhH8MD_78VxV_owrIVvnJkBWupXsUYuj9bbggLoxDP1VIdejlqIv086Di_tUdiVJlcL9DTA=s900-c-k-c0x00ffffff-no-rj);
...
<div class="container">
    <div class="frame">
        ...
        <script>
            let a="${requestScope.error}"; if(a=="error"){alert("sai tai khoan hoac mat khau")}
        </script>
